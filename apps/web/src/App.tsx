...
const navItems = [
  { id: "all", label: "Overview", icon: Gauge },
  { id: "studios", label: "Studios", icon: Sparkles },
...
export function App() {
  ...
  const showStudios = activeView === "all" || activeView === "studios";
  const showLibrary = activeView === "all" || activeView === "library";
  const showMixer = activeView === "all" || activeView === "mixer";
              ...
              <div className="export-layout">
                ...
                >
                  ...
                  <section className="tts-subpanel">
                    ...
                    <p>
                      {exportWorkflow.sceneWorksHandoff.packageManifestPath}
                    </p>
                    <small>
            ...
            >
              ...
              <div className="composition-bottom-grid">
                ...
                >
                  ...
                  <ol className="voice-checks">
                    {compositionEditor.sourceFlows.map((flow) => (
                      <li
                        className={
                          flow.status === "ready" ? "passed" : "failed"
                        }
                ...
                <section className="tts-subpanel" aria-label="Render plan">
                  ...
                  <small>
                    {compositionEditor.exportPlan.sceneWorksWarning}
                  </small>
                </section>
          ...
          <>
            ...
            <section className="voice-lab-panel" aria-label="Voice Lab">
              ...
              <div className="voice-lab-layout">
                <div
                  className="voice-profile-column"
                ...
                <div className="voice-side">
                  ...
                  >
                    ...
                    <div className="output-card">
                      ...
                      <small>
                        {voiceLab.savedOutput.asset.currentVersionId}
                      </small>
            ...
            <section className="sfx-studio-panel" aria-label="SFX and Ambience">
              ...
              <div className="sfx-metrics" aria-label="SFX workflow status">
                ...
                <div>
                  <Gauge aria-hidden="true" size={18} />
                  <strong>
                    {formatDuration(sfxStudio.controls.durationMs)}
                  </strong>
                  <span>
                    ...
                    {sfxStudio.variants.map((variant) => (
                      ...
                      >
                        ...
                        <small>
                          ...
                          {variant.loudnessLufs} LUFS / {variant.truePeakDbfs}{" "}
                          dBTP
                        </small>
                        <p>
                          {variant.loopPoints
            ...
            <section
              className="video-to-audio-panel"
              aria-label="Video to Audio"
            >
              ...
              <div className="video-metrics" aria-label="Video-to-audio status">
                <div>
                  <FileVideo aria-hidden="true" size={18} />
                  <strong>
                    {formatDuration(videoToAudio.source.durationMs)}
                  </strong>
              ...
              <div className="video-layout">
                <div className="video-main">
                  ...
                  >
                    ...
                    <div className="candidate-strip">
                      <span>
                        {statusLabel(videoToAudio.direction.syncMode)}
                      </span>
                      <span>
                  ...
                  <div
                    className="video-event-grid"
                    aria-label="Detected events"
                  >
            ...
            >
              <div className="samples-header">
                ...
                >
                  <Disc3 aria-hidden="true" size={18} />
                  <span>
                    {samplesStudio.submission.canSubmit
                      ? "Generate"
                      : "Blocked"}
                  </span>
                </button>
              ...
              <div
                ...
                aria-label="Samples workflow status"
              >
                <div>
                  <Boxes aria-hidden="true" size={18} />
              ...
              <div className="samples-layout">
                <div className="samples-main">
                  <section
                    className="sfx-prompt-panel"
                    aria-label="Sample prompt"
                  >
                    <div className="subpanel-heading">
                      <h3>
                        {statusLabel(samplesStudio.prompt.instrumentFamily)}
                      </h3>
                ...
                <div className="samples-side">
                  ...
                  >
                    <div className="subpanel-heading">
                      <h3>Pack</h3>
                      <span>
                        {samplesStudio.pack.exportFormats.join(" / ")}
                      </span>
                    </div>
              ...
              <div className="samples-review-grid">
                <ol
                  className="voice-checks"
                  aria-label="Sample post-processing"
                >
            ...
            >
              ...
              <div
                className="samples-metrics"
                aria-label="Song workflow status"
              >
                <div>
                  <Music2 aria-hidden="true" size={18} />
                ...
                <div className="samples-main">
                  ...
                  >
                    ...
                    <div>
                      <strong>
                        {formatDuration(
                          songStudio.arrangement.estimatedDurationMs,
                        )}
                      </strong>
                      <span>arranged</span>
                    </div>
                    ...
                    <div>
                      <strong>
                        {songStudio.controls.requestedStems.length}
                      </strong>
                      <span>stems</span>
                    </div>
                  </div>
                  ...
                  >
                    {songStudio.variants.map((variant) => (
                      ...
                      >
                        ...
                        <small>
                          {formatDuration(variant.durationMs)} / {variant.bpm}{" "}
                          BPM / {variant.musicalKey}
                        </small>
                        <p>
            ...
            >
              ...
              <div className="review-layout">
                ...
                <div className="review-side">
                  ...
                  <section className="tts-subpanel" aria-label="Edited version">
                    ...
                    <div className="output-card">
                      ...
                      <small>
                        v
                        {
                          reviewWorkspace.editSubmission.savedVersion
                            .versionIndex
                        }{" "}
                        /{" "}
                        {
                  ...
                  >
                    ...
                    <div className="output-card">
                      <strong>
                        {reviewWorkspace.provenance.editRecipe.id}
                      </strong>
                      <small>
                        {statusLabel(
              ...
              <div className="samples-review-grid">
                ...
                <ol className="voice-checks" aria-label="Review shortcuts">
                  {reviewWorkspace.transport.keyboardShortcuts.map(
                    (shortcut) => (
