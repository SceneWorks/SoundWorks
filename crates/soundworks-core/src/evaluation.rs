...
fn reference_candidates() -> Vec<ModelEvaluationCandidate> {
    vec![
        candidate(
            ...
            vec![ScoreFocus::PromptAdherence, ScoreFocus::SongStructure, ScoreFocus::DurationStability, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            vec!["License terms and no-Python product path are unresolved"],
        ...
        candidate(
            ...
            ProductEligibility::ResearchOnly,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::LyricAlignment, ScoreFocus::SongStructure, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            vec![ScoreFocus::Intelligibility, ScoreFocus::RuntimeFootprint, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::SpeakerConsistency, ScoreFocus::LicenseSafety],
            vec!["Non-commercial model license requires SoundWorks compatibility review", "Reference clip requirement must be normalized as 6 seconds from the model card unless docs are reconciled"],
        ...
        candidate(
            ...
            ProductEligibility::Blocked,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::Intelligibility, ScoreFocus::LicenseSafety],
            vec!["Non-commercial model license requires SoundWorks compatibility review"],
            "Research comparison only until packaging and license compatibility are resolved.",
        ),
        candidate(
            "fish-speech",
            "Fish Speech",
        ...
        candidate(
            ...
            ProductEligibility::NeedsRuntimePort,
            EvidenceLevel::InstallDocumented,
            vec![ScoreFocus::SpeakerConsistency, ScoreFocus::ProsodyControl, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            ProductEligibility::Blocked,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::Intelligibility, ScoreFocus::SpeakerConsistency, ScoreFocus::LicenseSafety],
            vec!["Pretrained model license requires SoundWorks compatibility review"],
        ...
        candidate(
            ...
            ProductEligibility::NeedsRuntimePort,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::SpeakerConsistency, ScoreFocus::RuntimeFootprint, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            ProductEligibility::NeedsRuntimePort,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::PromptAdherence, ScoreFocus::Loopability, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            vec!["Model card requires downstream risk investigation before SoundWorks use"],
        ...
        candidate(
            ...
            ProductEligibility::Blocked,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::PromptAdherence, ScoreFocus::LicenseSafety],
            vec!["Non-commercial checkpoint license requires SoundWorks compatibility review"],
        ...
        candidate(
            ...
            ProductEligibility::ResearchOnly,
            EvidenceLevel::SourceMetadata,
            vec![ScoreFocus::PromptAdherence, ScoreFocus::DurationStability, ScoreFocus::LicenseSafety],
        ...
        candidate(
            ...
            vec!["License terms and no-Python product path unresolved"],
        ...
        candidate(
            ...
            ProductEligibility::ProductCandidate,
            EvidenceLevel::InstallDocumented,
            vec![ScoreFocus::PromptAdherence, ScoreFocus::DurationStability, ScoreFocus::RuntimeFootprint, ScoreFocus::LicenseSafety],
    ...
    vec![
        lane(
            ...
            &[
                ...
                ("safety", "Consent and license safety", 10),
            ],
        ),
        lane(
            EvaluationLane::VoiceClone,
