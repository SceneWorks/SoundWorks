...
fn requirement_coverage() -> Vec<RequirementCoverage> {
    vec![
        ...
        coverage("epic-req-7", "Capability-based provider manifests rather than one-off model assumptions.", &["demo-video-foley", "demo-stem-separation"], &["fixture-video-foley", "fixture-stem-bundle"], &["check-provider-manifests"], MvpValidationStatus::Passed),
